...
export type ElementalTypePokemonsArgs = {
...
export type ElementalTypeAttacksArgs = {
...
export type ResolversTypes = {
  ...
  ElementalType: ResolverTypeWrapper<
    Omit<ElementalType, "pokemons" | "attacks"> & {
      pokemons?: Maybe<Array<ResolversTypes["Pokemon"]>>;
...
export type ResolversParentTypes = {
  ...
  PokemonOrderByInput: PokemonOrderByInput;
  Pokemon: Pokemon;
  ElementalType: Omit<ElementalType, "pokemons" | "attacks"> & {
    pokemons?: Maybe<Array<ResolversTypes["Pokemon"]>>;
    attacks?: Maybe<Array<ResolversTypes["Attack"]>>;
  };
  AttackOrderByInput: AttackOrderByInput;
...
> = {
  ...
  pokemons?: Resolver<
    ...
    ParentType,
    ContextType,
    ElementalTypePokemonsArgs
  >;
  attacks?: Resolver<
    Maybe<Array<ResolversTypes["Attack"]>>,
    ParentType,
    ContextType,
    ElementalTypeAttacksArgs
  >;
